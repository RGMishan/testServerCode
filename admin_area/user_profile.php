...
<div class="panel-body">
  ...
  enctype="multipart/form-data"> <!--form-horizontol Starts -->
  
  <div class="form-group">
    <label class="col-md-3 control-label">User Name: </label>
    <div class="col-md-6">
        <input type="text" name="admin_name" class="form-control"
        required value="<?php echo $admin_name; ?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
        ...
        required value="<?php echo $admin_email; ?>">
    </div>
  </div>
  <div class="form-group">
    ...
    <div class="col-md-6">
        ...
        required value="<?php echo $admin_pass; ?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
        <input type="text" name="admin_email" class="form-control"
        required value="<?php echo $admin_country; ?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
        ...
        required value="<?php echo $admin_job; ?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
        ...
        required value="<?php echo $admin_contact; ?>">
    </div>
  </div>
  ...
  <div class="form-group">
    ...
    <div class="col-md-6">
        <input type="text" name="admin_about" class="form-control"
        required value="<?php echo $admin_about; ?>">
    </div>
  </div>
...
if (isset($_POST['update'])) {
    ...
    if ($run_admin) {
        echo "<script> alert('User has Been Added. Login Again') </script>";
        echo "<script>window.open('login.php', '_self')</script>";
